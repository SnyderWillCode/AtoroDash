...
class Billing extends Database
{
    ...
    public static function updateBilling(
        ...
        try {
            ...
            self::db_Error('Failed to update billing: ' . $e->getMessage());
        }
    }
    ...
    public static function getBillingData(string $uuid): array
    {
        try {
            ...
            self::db_Error('Failed to get billing data: ' . $e->getMessage());
    ...
    private static function doesHaveBilling(string $uuid): bool
    {
        try {
            ...
            self::db_Error('Failed to check for existing billing details: ' . $e->getMessage());
