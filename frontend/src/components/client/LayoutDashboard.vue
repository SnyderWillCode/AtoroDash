  ...
  <div class="min-h-screen bg-[#0a0a1f] relative overflow-hidden">
    ...
    <div class="relative z-10 min-h-screen">
      ...
      <template v-if="!loading">
        ...
        <!-- Footer -->
        <footer class="relative z-10 py-4 px-6 text-center text-sm text-gray-400">
...
import { SettingsIcon, LogOutIcon, UsersIcon } from 'lucide-vue-next'
...
const handleVisibilityChange = () => {
  document.title = document.hidden
    ...
    : document.title.replace(' - Inactive', '')
}
